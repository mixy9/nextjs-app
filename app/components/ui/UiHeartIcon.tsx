...
const HeartIcon = ({onClick, active}) => (
  <button
    ...
    <svg
      ...
      fill="currentColor"
      className={
      `${!active ? 'opacity-25' : 'fill-cyan-500'} 
      absolute m-2 top-0 right-0 hover:fill-cyan-500 hover:opacity-100`}
      height={25}
      width={25}
    >
      <path d="m11.645 20.91-.007-.003-.022-.012a15.247 15.247 0 0 1-.383-.218 25.18 25.18 0 0 1-4.244-3.17C4.688 15.36
